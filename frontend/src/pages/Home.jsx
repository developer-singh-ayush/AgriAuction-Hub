...
import backgroundImage from '../assets/bgimg.jpeg';
const Home = () => {
  return (
    <div className="bg-green-50">
      {/* Hero Section */}
      <section
        className="h-screen flex flex-col justify-center items-center bg-green-600 text-white"
        style={{
      ...
      >
        <div className="text-center px-4 md:px-10 bg-green-600 bg-opacity-75 rounded-lg p-8">
